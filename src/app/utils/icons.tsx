...
export function TeamIcon({ color, className }: SolutionIconsProps) {
  return (
    <svg
      height="100%"
      fill={color ? color : "#693f91"}
...
export function SolutionsIcon({ color, className }: SolutionIconsProps) {
  return (
    <svg
      height="100%"
       style={{ padding: '10%' }}
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g>
          ...
          <g>
            {" "}
            <circle cx="372.26" cy="148.34" r="40.502"></circle>{" "}
          </g>{" "}
        </g>{" "}
        <g>
          {" "}
        ...
        <g>
          ...
          <g>
            {" "}
            <circle cx="139.745" cy="148.34" r="40.502"></circle>{" "}
          </g>{" "}
        </g>{" "}
        <g>
          {" "}
