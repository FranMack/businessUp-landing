      ...
      <div className="w-full h-full absolute flex text-[#ffff] text-start">
        ...
        <div className="w-[80%] flex flex-col gap-y-[2vh]">
          <h1 className=" text-[3rem] font-semibold ">
            Tecnológia de vanguardia
            para líderes visionarios
          </h1>
          <h2 className="text-[1.1rem]">
            Te ayudamos a pensar distinto, operar mejor y liderar con<br/>
            tecnología, para que te adelantes al cambio y ejecutes con<br/>
            precisión.
          </h2>
          <h3 className="mt-[3vh] text-[1.3rem]">¿Estás listo para crecer sin límites?</h3>
          </div>
        </div>

        <div className=" h-full w-1/2 text-[1.5rem] flex justify-center items-end">
        <div className="w-[70%] aspect-square relative mb-[5%]">
  <Image
        fill
