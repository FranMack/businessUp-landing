...
export const SolutionCenter = () => {
  ...
  return (
    <div ref={refSolutionGraph} className="xs:hidden lg:flex justify-center xs:w-[60vw] xs:h-[60vw] lg:w-[16vw] lg:h-[16vw]   border border-primary rounded-full relative border-dashed">
      <div
        onMouseEnter={() => {
          handleFocus("desarrollos");
        }}
     
        className={`group xs:w-[20vw] xs:h-[20vw] lg:w-[6vw] lg:h-[6vw]   ${
      ...
      >
        ...
        />
        <p className="absolute xs:top-[-5vh] lg:top-auto left-[-7vw] text-[1.1rem] font-semibold">
          Desarrollos
        </p>
      </div>
      <div
