...
export const Hero = () => {
  return (
    <section id="hero" className="w-screen h-screen relative ">
      ...
      <div className="w-full h-full absolute flex xs:flex-col lg:flex-row text-[#ffff] text-start xs:pt-[10vh] lg:pt-0 ">
        <div className=" h-full xs:w-full lg:w-1/2 flex justify-center items-center ">
          <div className="w-[80%] flex flex-col gap-y-[2vh]">
            ...
            <h2 className=" xs:text-[1rem] lg:text-[1.1rem]">
            ...
            <h3 className="lg:mt-[3vh] xs:text-[1.1rem] lg:text-[1.3rem]">
        ...
        <div className=" h-full xs:w-full  lg:w-1/2 text-[1.5rem] flex justify-center items-end ">
          <div className="xs:w-[80%] lg:w-[75%] aspect-square relative mb-[5%]">
            <Image
              fill
